...
#
# indexes = [
#   { name = "index_ruby_implementations_on_slug", columns = ["slug"], unique = true },
#   { name = "index_ruby_implementations_on_name", columns = ["name"], unique = true }
# ]
#
# [callbacks]
...
class RubyImplementation < ApplicationRecord

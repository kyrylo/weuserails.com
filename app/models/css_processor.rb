...
#
# indexes = [
#   { name = "index_css_processors_on_slug", columns = ["slug"], unique = true },
#   { name = "index_css_processors_on_name", columns = ["name"], unique = true }
# ]
#
# [callbacks]
...
class CssProcessor < ApplicationRecord

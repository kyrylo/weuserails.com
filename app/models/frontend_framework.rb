...
#
# indexes = [
#   { name = "index_frontend_frameworks_on_slug", columns = ["slug"], unique = true },
#   { name = "index_frontend_frameworks_on_name", columns = ["name"], unique = true }
# ]
#
# [callbacks]

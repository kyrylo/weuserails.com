...
# table = "background_job_libraries"
...
#
# indexes = [
#   { name = "index_background_job_libraries_on_slug", columns = ["slug"], unique = true },
#   { name = "index_background_job_libraries_on_name", columns = ["name"], unique = true }
# ]
#
# [callbacks]
...
class BackgroundJobLibrary < ApplicationRecord

...
#
# indexes = [
#   { name = "index_css_frameworks_on_slug", columns = ["slug"], unique = true },
#   { name = "index_css_frameworks_on_name", columns = ["name"], unique = true }
# ]
#
# [callbacks]
...
class CssFramework < ApplicationRecord

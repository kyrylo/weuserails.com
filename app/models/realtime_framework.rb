...
#
# indexes = [
#   { name = "index_realtime_frameworks_on_slug", columns = ["slug"], unique = true },
#   { name = "index_realtime_frameworks_on_name", columns = ["name"], unique = true }
# ]
#
# [callbacks]
...
class RealtimeFramework < ApplicationRecord
